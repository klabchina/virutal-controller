...
{
    public class AdvCommandLap : AdvCommandBase
    {
#region public methods
        ...
        public AdvCommandLap(AdvCommandBase command) : base(command)
        {
        ...
        public override bool Execute(AdvMainEngine engine)
        {
            ...
            {
                AdvDebugTimeMonitor monitor = debugStatusManager.GetMonitor<AdvDebugTimeMonitor>();
                if (monitor != null)
                {
                    monitor.RecodeLap();
                }
