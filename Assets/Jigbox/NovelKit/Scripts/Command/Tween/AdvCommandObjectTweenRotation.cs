...
namespace Jigbox.NovelKit
{
    ...
    public class AdvCommandObjectTweenRotation : AdvCommandObjectTween
    {
#region public methods
        ...
        public AdvCommandObjectTweenRotation(AdvCommandBase command, ObjectType objectType, bool isSub = false)
...
#region protected methods
        ...
        protected override void CommandProcess(AdvMainEngine engine, AdvObjectBase obj)
        {
            ...
            tween.Begin = from;
            tween.Final = to;
            tween.OnUpdate(t => obj.Rotation = t.Value);
