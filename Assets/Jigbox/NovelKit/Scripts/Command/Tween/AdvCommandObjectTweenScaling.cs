...
namespace Jigbox.NovelKit
{
    ...
    public class AdvCommandObjectTweenScaling : AdvCommandObjectTween
    {
#region public methods
        ...
        public AdvCommandObjectTweenScaling(AdvCommandBase command, ObjectType objectType, bool isSub = false)
...
#region protected methods
        ...
        protected override void CommandProcess(AdvMainEngine engine, AdvObjectBase obj)
        {
            ...
            tween.Begin = from;
            tween.Final = to;
            tween.OnUpdate(t => obj.Scale = t.Value);
