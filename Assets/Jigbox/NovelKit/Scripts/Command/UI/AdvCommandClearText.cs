...
{
    public class AdvCommandClearText : AdvCommandBase
    {
#region public methods
        ...
        public AdvCommandClearText(AdvCommandBase command) : base(command)
        {
        ...
        {
            engine.UIManager.WindowManager.ActiveWindow.TextController.ClearText();
            return true;
        }
