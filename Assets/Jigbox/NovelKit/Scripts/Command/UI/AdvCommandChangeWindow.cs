...
{
    public class AdvCommandChangeWindow : AdvCommandBase
    {
#region properties
        ...
        /// <summary>ウィンドウのインデックスのパラメータ</summary>
        protected string IndexParam { get { return Param[1]; } }

        /// <summary>ウィンドウのインデックス</summary>
...
#region public methods
        ...
        public AdvCommandChangeWindow(AdvCommandBase command) : base(command)
        {
            ...
            if (!int.TryParse(IndexParam, out index))
            {
                Type = CommandType.ErrorCommand;
                ErrorMessage = "ウィンドウインデックスの指定が不正です。";
                return;
            }
            if (index <= 0)
            {
                ...
                Type = CommandType.ErrorCommand;
                ErrorMessage = "インデックスに0以下の値を設定することはできません。";
                return;
            }
        }
        ...
        {
            engine.UIManager.WindowManager.ChangeActive(index);
            return true;
        }
