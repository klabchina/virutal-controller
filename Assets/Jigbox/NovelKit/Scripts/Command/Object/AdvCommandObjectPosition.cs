...
namespace Jigbox.NovelKit
{
    ...
    public class AdvCommandObjectPosition : AdvCommandTransformBase
    {
#region public methods
        ...
        public AdvCommandObjectPosition(AdvCommandBase command, ObjectType objectType, bool isSub = false)
...
#region protected methods
        ...
        {
            obj.Position = CalculateValue(obj.Position);
        }
