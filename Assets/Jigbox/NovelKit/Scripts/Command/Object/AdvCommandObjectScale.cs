...
namespace Jigbox.NovelKit
{
    ...
    public class AdvCommandObjectScale : AdvCommandTransformBase
    {
#region public methods
        ...
        public AdvCommandObjectScale(AdvCommandBase command, ObjectType objectType, bool isSub = false)
...
#region protected methods
        ...
        {
            obj.Scale = CalculateValue(obj.Scale);
        }
