...
namespace Jigbox.NovelKit
{
    ...
    public class AdvCommandObjectDelete : AdvObjectCommandBase
    {
#region public methods
        ...
        public AdvCommandObjectDelete(AdvCommandBase command, ObjectType objectType, bool isSub = false)
...
#region protected methods
        ...
        protected override void CommandProcess(AdvMainEngine engine, AdvObjectBase obj)
        {
            if (!isSub)
            {
                engine.ObjectManager.UnregisterObject(obj);
            }
            else
            {
                AdvObjectBase parent = obj.transform.parent.gameObject.GetComponent<AdvObjectBase>();
                parent.UnregisterSubObject(subId);
            }
            obj.Delete();
        }
