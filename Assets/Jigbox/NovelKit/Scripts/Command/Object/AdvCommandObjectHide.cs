...
namespace Jigbox.NovelKit
{
    ...
    public class AdvCommandObjectHide : AdvCommandObjectShow
    {
#region public methods
        ...
        public AdvCommandObjectHide(AdvCommandBase command, ObjectType objectType, bool isSub = false)
...
#region protected methods
        ...
        protected override void CommandProcess(AdvMainEngine engine, AdvObjectBase obj)
        {
            if (obj is IAdvObjectShowTransition)
            {
                ...
                {
                    transitionObject.Hide(GetScaledTime(engine, transitionTime));
                }
                else
                {
                    transitionObject.Hide(GetScaledTime(engine, transitionObject.ShowTransitionTime));
                }
