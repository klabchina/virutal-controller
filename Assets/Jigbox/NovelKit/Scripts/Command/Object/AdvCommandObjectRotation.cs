...
namespace Jigbox.NovelKit
{
    ...
    public class AdvCommandObjectRotation : AdvCommandTransformBase
    {
#region public methods
        ...
        public AdvCommandObjectRotation(AdvCommandBase command, ObjectType objectType, bool isSub = false)
...
#region protected methods
        ...
        {
            obj.Rotation = CalculateValue(obj.Rotation);
        }
