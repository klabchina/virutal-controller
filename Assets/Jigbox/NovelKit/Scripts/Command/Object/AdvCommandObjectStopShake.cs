...
namespace Jigbox.NovelKit
{
    ...
    public class AdvCommandObjectStopShake : AdvObjectCommandBase
    {
#region public methods
        ...
        public AdvCommandObjectStopShake(AdvCommandBase command, ObjectType objectType, bool isSub = false)
