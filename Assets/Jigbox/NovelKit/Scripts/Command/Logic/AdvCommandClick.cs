...
{
    public class AdvCommandClick : AdvCommandBase
    {
#region constants
...
#region public methods
        ...
        public AdvCommandClick(AdvCommandBase command) : base(command)
        {
        ...
        {
            engine.UIManager.SetTouchEnable(isEnable);
            return true;
        }
