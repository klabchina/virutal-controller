...
{
    public class AdvCommandSuspend : AdvCommandBase
    {
#region public methods
        ...
        public AdvCommandSuspend(AdvCommandBase command) : base(command)
        {
        ...
        {
            engine.StatusManager.State.Wait(AdvPlayStateManager.PlayState.Suspend);
            return false;
        }
