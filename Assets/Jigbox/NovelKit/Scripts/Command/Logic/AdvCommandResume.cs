...
{
    public class AdvCommandResume : AdvCommandBase
    {
#region public methods
        ...
        public AdvCommandResume(AdvCommandBase command) : base(command)
        {
        ...
        {
            engine.StatusManager.State.WaitRelease(AdvPlayStateManager.PlayState.Suspend);
            return false;
        }
