...
{
    [Serializable]
    public class ScrollSelectModelVertical : ScrollSelectModelBase
    {
...
#region Fields & Properties
        ...
        protected override float CellPositionOffsetRate { get { return 0.5f - CellPivot.y; } }

        /// <summary>可視領域の長さ</summary>
        public override float ViewportLength { get { return ViewportSize.y; } }

        /// <summary>スクロール量</summary>
        protected override float ScrollValue { get { return ScrollPosition.y; } }
        ...
        public override float SelectedCellDelta
        {
            get
            {
                return selectedCellPositionDelta.y;
            }
            protected set
            {
                selectedCellPositionDelta.y = value;
            }
        }
        ...
        protected override IScrollSelectLoopTypeLogic GetLoopTypeLogic()
        {
            ...
            {
                return new ScrollSelectVerticalLoopLogic(new ScrollSelectLoopTypeLogicProperty(this));
            }
            else
            {
                return new ScrollSelectVerticalNoneLoopLogic(new ScrollSelectLoopTypeLogicProperty(this));
            }
        }
        ...
        {
            ScrollPosition = ScrollOriginPoint + ScrollPosition - scrollPosition;
        }
