...
{
    public sealed class MarqueeStateMachine
    {
#region inner classes, enum, and structs
        ...
        class State
        {
            ...
            /// <returns></returns>
            public bool IsValid(MarqueeState state)
            {
...
#region properties
        ...
        public MarqueeState StateType { get; private set; }
...
#region public methods
        ...
        /// コンストラクタ
        /// </summary>
        public MarqueeStateMachine()
        {
            StateType = MarqueeState.Idle;
            Changed = false;
        }
        ...
        public bool Add(
            MarqueeState stateType,
            Action onEnter = null,
            Action<float> onUpdate = null,
            Action onExit = null,
            int validateMask = (int) MarqueeState.All)
        {
        ...
        public bool Set(MarqueeState stateType)
        {
