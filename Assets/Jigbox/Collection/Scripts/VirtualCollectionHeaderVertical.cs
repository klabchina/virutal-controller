...
{
    /// <summary>
    /// ListView、TileViewのVertical用のヘッダにつけるコンポーネントです
    /// </summary>
    public class VirtualCollectionHeaderVertical : VirtualCollectionHeader
    {
        /// <summary>anchorMinに設定する値</summary>
        protected override Vector2 AnchorMin { get { return new Vector2(0, 1); } }
        ...
        protected override void UpdateOffset(Padding padding)
        {
            ...
            RectTransform.offsetMin = new Vector2(padding.Left, -padding.Top - size);
