...
{
    /// <summary>
    /// ListView、TileViewのHorizontal用のヘッダにつけるコンポーネントです
    /// </summary>
    public class VirtualCollectionHeaderHorizontal : VirtualCollectionHeader
    {
        ...
        protected override Vector2 AnchorMax { get { return new Vector2(0, 1); }}
        ...
        protected override void UpdateOffset(Padding padding)
        {
            ...
            RectTransform.offsetMax = new Vector2(padding.Left + size, -padding.Top);
        }
