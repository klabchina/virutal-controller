...
{
    public class SpringShakeBehaviour<TValue, TSpringShake> : PeriodicMovementBehaviour<TValue, TSpringShake>
        where TSpringShake : SpringShake<TValue, TSpringShake>
    {
        /// <summary>コンストラクター</summary>
        /// <param name="periodicMovement">対象の <c>SpringShake</c></param>
        public SpringShakeBehaviour(TSpringShake periodicMovement) : base(periodicMovement) {}
