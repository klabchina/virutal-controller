...
namespace ArabicUtils
{
    ...
    public sealed class CaretUnit
    {
        ...
        public CaretUnit(int srcIndex, int srcLength, int dstIndex, int dstLength, bool isRightToLeft)
        {
        ...
        public CaretUnit Shift()
        {
            return new CaretUnit(source.index, source.length, destination.index + 1, destination.length, isRightToLeft);
        }
    }
}
