...
{
    public sealed class RightBracketTokenizer : ArabicTextTokenizer
    {
#region properties

        /// <summary>トークンの種類</summary>
        protected override TokenType Type { get { return TokenType.RightBracket; } }
...
#region protected methods
        ...
        {
            // 括弧のトークンは1文字ずつにする
            return BracketTable.IsRightBracket(character) && length < 1;
        }
