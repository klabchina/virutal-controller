...
{
    public sealed class ArabicNumberTokenizer : ArabicTextTokenizer
    {
#region properties

        /// <summary>トークンの種類</summary>
        protected override TokenType Type { get { return TokenType.ArabicNumber; } }
...
#region protected methods
        ...
        {
            return (int) character >= ArabicLetter.ArabicDigitZero && (int) character <= ArabicLetter.ArabicDigitNine; 
        }
