...
{
    public sealed class NumberTokenizer : ArabicTextTokenizer
    {
#region properties

        /// <summary>トークンの種類</summary>
        protected override TokenType Type { get { return TokenType.Number; } }
...
#region protected methods
        ...
        {
            return !ArabicLetter.IsArabic(character) && char.IsNumber(character);
        }
