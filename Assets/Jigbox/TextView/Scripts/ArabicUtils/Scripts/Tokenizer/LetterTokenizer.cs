...
{
    public sealed class LetterTokenizer : ArabicTextTokenizer
    {
#region properties

        /// <summary>トークンの種類</summary>
        protected override TokenType Type { get { return TokenType.Letter; } }
...
#region protected methods
        ...
        {
            return !ArabicLetter.IsArabic(character) && char.IsLetter(character);
        }
