...
namespace Jigbox.Examples
{
	...
	public class TextVerticalAlignSelector : MonoBehaviour
	{
		[SerializeField]
		...
		void OnValueChanged (bool isChecked)
		{
			...
			if (isChecked && targetTextView != null && targetTextView.VerticalAlignment != verticalAlign) {
				targetTextView.VerticalAlignment = verticalAlign;
			}
		}
